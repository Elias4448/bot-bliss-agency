export const BackgroundBlobs = () => {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      <div 
        className="absolute -top-40 -right-40 w-[600px] h-[600px] rounded-full opacity-60 animate-float"
        style={{
      ...
      {/* Medium blob center */}
      <div 
        className="absolute top-1/2 left-1/4 w-[500px] h-[500px] rounded-full opacity-50 animate-float-delayed"
        style={{
      ...
      <div 
        className="absolute -bottom-20 left-10 w-[400px] h-[400px] rounded-full opacity-40 animate-float"
        style={{
      ...
      <div 
        className="absolute top-1/3 -right-20 w-[450px] h-[450px] rounded-full opacity-50 animate-float-delayed"
        style={{
