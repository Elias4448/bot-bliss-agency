...
export const Hero = () => {
  return <section className="relative min-h-[90vh] flex items-center justify-center px-6 py-20">
      <div className="max-w-5xl mx-auto text-center">
        ...
        {/* Subheading */}
        <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">Wir bauen KI-Telefonassistenten und Automationslösungen, die <span className="font-bold text-foreground">Zeit sparen & Kosten senken</span>. Entlasten Sie Ihre Mitarbeiter mit intelligenten KI-Prozessen – <span className="font-bold text-foreground">ohne Mehraufwand</span>.</p>
