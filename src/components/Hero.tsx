...
export const Hero = () => {
  return <section className="relative min-h-[90vh] flex items-center justify-center px-6 py-20">
      <div className="max-w-5xl mx-auto text-center">
        ...
        {/* Subheading */}
        <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">Wir entwickeln maßgeschneiderte KI-Assistenten und Automatisierungen, die Anfragen beantworten, Prozesse ausführen und Teams spürbar entlasten. So gewinnen Sie Zeit, reduzieren Kosten und steigern die Effizienz – ohne Mehraufwand.</p>
