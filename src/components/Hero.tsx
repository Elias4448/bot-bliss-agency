...
export const Hero = () => {
  return <section className="relative min-h-[90vh] flex items-center justify-center px-6 py-12">
      <div className="max-w-5xl mx-auto text-center pt-8 md:pt-12">
        ...
        {/* Subheading */}
        <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">Kubrix ist Ihr fehlender Baustein für effizientere Prozesse. Wir entwickeln KI-Assistenten und Automationen, die entlasten, beschleunigen und echte Effizienz  schaffen – zuverlässig, messbar und sofort spürbar. </p>
