    ...
    <section className="py-24 px-6 relative overflow-hidden">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 tracking-tight">
          Lass KI deine Anrufe wie ein<br />Mensch übernehmen
        </h2>
        <p className="text-muted-foreground text-lg mb-12">
          Teste jetzt unsere KI in einem Anruf
        </p>
          ...
          <div className="relative bg-card rounded-2xl p-6 shadow-lg">
            <form onSubmit={handleSubmit} className="space-y-4">
              <Input
                ...
                className="h-12 text-base bg-muted/50 border-0 rounded-xl text-center placeholder:text-muted-foreground/60"
              />
              <Button 
                type="submit" 
                disabled={isLoading}
                className="w-full h-12 text-base font-medium rounded-xl bg-foreground text-background hover:bg-foreground/90"
              >
                {isLoading ? (
